...
export const updates: Update[] = [
  {
    date: "2026-08-26",
    text: "Mana's Windows launcher only ever knew how to start Kokoro, its fallback TTS voice, and defaulted TTS_PROVIDER to match. Fish Speech, the actual default, had no startup path at all until a user noticed the voice was wrong.",
    href: "/blog/the-native-launcher-that-never-started-its-default-voice/",
  },
  {
    date: "2026-08-25",
