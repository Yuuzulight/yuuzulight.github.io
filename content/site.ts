...
export const updates: Update[] = [
  {
    date: "2026-09-07",
    text: "Mana's snapshot staleness check compared millisecond timestamps as strings, so two snapshots written in the same millisecond, routine for back-to-back in-memory writes, tied and a genuinely newer write could slip past unflagged.",
    href: "/blog/the-staleness-check-that-couldnt-tell-two-writes-apart/",
  },
  {
    date: "2026-09-04",
